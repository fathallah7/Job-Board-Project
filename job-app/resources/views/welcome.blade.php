    ...
    <div x-data="{ show: false }" x-init="setTimeout(() => show = true, 300)">
        <div x-cloak x-show="show" x-transition:enter="transition ease-out duration-700"
            ...
            <a href="{{ route('register') }}"
                class="rounded-lg bg-white/10 hover:bg-white/20 transition duration-300 px-4 py-2 text-white font-medium mr-2">
                Create an Account
            </a>

            <a href="{{ route('login') }}"
                class="rounded-lg bg-indigo-600 hover:bg-indigo-900 transition duration-300  px-4 py-2 text-white font-medium">
                Login
            </a>
